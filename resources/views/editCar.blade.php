                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('updateCar', ['id' => $car->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                ...
                                                <img src="{{ asset('../assets/admin/images/' . $car->image) }}" alt="" style="width: 300px;">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                ...
                                                <select class="form-control" name="category_id" id="">
                                                    ...
                                                    <option value="{{ $category->id }}" @if($category->id == $car->category_id) selected="selected" @endif>
