                ...
                <div class="row align-items-end ">
                    <div class="col-lg-12">
                        ...
                        <div class="intro">
                            ...
                            <div class="pb-4"><strong class="text-black">Posted on {{ \Carbon\Carbon::parse($car->created_at)->format('M j, Y') }}</strong></div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 blog-content">
                        <img src="{{asset('assets/admin/images/'.$car->image) }}" alt="" class="img-fluid p-3 mb-5 bg-white rounded">
                    ...
                    <div class="col-md-4 sidebar">
                        ...
                        <div class="sidebar-box">
                            <div class="categories">
                                ...
                                <li>
                                    <a href="#"> {{ $category->category_name }} <span>({{ $category->cars_count }}) </span> </a>
                                </li>
                                @endforeach
